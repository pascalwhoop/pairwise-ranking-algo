...
export class PairwiseRanker {
    ...
    getRankings() {
        ...
        const rankedItems = itemData.map(item => {
    ...
    isSessionComplete() {
        ...
        const allConfident = Object.values(this.items).every(item => item.confidence >= this._options.confidenceThreshold);
        return allConfident;
    }
    /**
